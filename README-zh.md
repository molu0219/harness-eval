...
[![適用 Cursor](https://img.shields.io/badge/Cursor-compatible-blue?style=flat-square)](https://cursor.sh)
[![適用 Windsurf](https://img.shields.io/badge/Windsurf-compatible-teal?style=flat-square)](https://windsurf.ai)
...
適用於：Claude Code harness · Cursor rules · Windsurf · Aider · CLAUDE.md 設定 · 任何 AI 開發配置
