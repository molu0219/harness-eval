...
[![Works with Cursor](https://img.shields.io/badge/Cursor-compatible-blue?style=flat-square)](https://cursor.sh)
[![Works with Windsurf](https://img.shields.io/badge/Windsurf-compatible-teal?style=flat-square)](https://windsurf.ai)
...
Works with: Claude Code harness · Cursor rules · Windsurf · Aider · CLAUDE.md setups · any AI dev config
